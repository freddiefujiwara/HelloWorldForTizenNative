#ifndef _HELLO_WORLD_FOR_TIZEN_NATIVE_APP_H_
#define _HELLO_WORLD_FOR_TIZEN_NATIVE_APP_H_
...
//  The HelloWorldForTizenNativeApp class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class HelloWorldForTizenNativeApp
...
public:
	...
	HelloWorldForTizenNativeApp(void);
	virtual ~HelloWorldForTizenNativeApp(void);
...
#endif // _HELLO_WORLD_FOR_TIZEN_NATIVE_APP_H_
